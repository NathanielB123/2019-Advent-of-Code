...
#        elif i[0]=="D":
#            Dir=[0,-1]
#        for i2 in range(0,int(i[1:len(i)])):
#            Wire1Positions.append([
#                Wire1Positions[len(Wire1Positions)-1][0]+Dir[0],
#                Wire1Positions[len(Wire1Positions)-1][1]+Dir[1]])
Closest=999999
for i in Wire2:
    if not i==None:
        if i[0]=="U":
           ...
           Dir=[0,-1]
        for i2 in range(0,int(i[1:len(i)])):
            Wire2Positions.append([
                Wire2Positions[len(Wire2Positions)-1][0]+Dir[0],
                Wire2Positions[len(Wire2Positions)-1][1]+Dir[1]])
            if Wire2Positions[len(Wire2Positions)-1] in Wire1Positions and len(Wire2Positions)>1:
                Closest=min(Closest,abs(Wire2Positions[len(Wire2Positions)-1][0])+abs(Wire2Positions[len(Wire2Positions)-1][1]))
                print(Closest)
                print(len(Wire2Positions))
print(Closest)
    ...
    if not i==None:
        ...
        for i2 in range(0,int(i[1:len(i)])):
            Wire2Positions.append([
                ...
                Wire2Positions[len(Wire2Positions)-1][1]+Dir[1]])
            if Wire2Positions[len(Wire2Positions)-1] in Wire1Positions and len(Wire2Positions)>1:
                for WireNum in range(0,len(Wire1Positions)):
                    if Wire1Positions[WireNum]==Wire2Positions[len(Wire2Positions)-1]:
                        Distance=WireNum+len(Wire2Positions)-1
                        break
